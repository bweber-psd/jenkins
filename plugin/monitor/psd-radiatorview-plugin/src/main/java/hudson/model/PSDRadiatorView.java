...
/**
 * A configurable Radiatlor-Style job view suitable for use in extreme feedback
 ...
 */
public class PSDRadiatorView extends ListView {
	/**
	 ...
	 */
//	transient Map<Item, Integer> placeInQueue = new HashMap<Item, Integer>();
	...
	public PSDRadiatorView(String name, Boolean showStable,
	...
	public PSDRadiatorView(String name)
	{
		super(name);
	}
...
//		placeInQueue = new HashMap<Item, Integer>();
//		int j = 1;
...
//		}
	...
	public static final class DescriptorImpl extends ViewDescriptor {
		public DescriptorImpl() {
			super(PSDRadiatorView.class);
		}

		@Override
		public String getDisplayName() {
			return "PSD Project Monitor";
		}
